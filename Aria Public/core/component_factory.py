...
class ComponentFactory:
    ...
    def _register_core_components(self):
        ...
        self.register_component(
            'snapshot_manager',
            factory=lambda: self._create_snapshot_manager(),
            singleton=True
        )

        self.register_component(
            'health_analyzer',
            factory=lambda: self._create_health_analyzer(),
            singleton=True
        )

        self.register_component(
            'session_templates',
            factory=lambda: self._create_session_templates(),
            singleton=True
        )
