"""
Lazy loading utilities to replace repetitive property patterns
"""
...
class LazyProperty:
    """Descriptor for lazy initialization of properties with proper cleanup"""
...
class LazyLoader:
    """Centralized lazy loading manager with cleanup support"""
    ...
    def register_lazy_property(self, name: str, factory: Callable[[], Any], 
        ...
        """Register a lazy-loaded property with optional cleanup"""
        if cleanup:
...
def lazy_property(func):
    """Decorator for lazy initialization of expensive components"""
...
def cleanup_lazy_components():
    """Cleanup all globally lazy-loaded components"""
